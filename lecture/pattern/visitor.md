...
> Parse-Tree vereinfacht - das nennt man dann auch oft "Abstract Syntax
> Tree" (*AST*). Wir werden so eine Transformation von einem
> vollständigen Parse-Tree hin zu einem AST auch noch als Übungsaufgabe
> programmieren und werden das Visitor-Pattern nutzen, um den Parse-Tree
> zu traversieren.
...
Matching](../java-modern/patternmatching.md) genauer an, hier nur der
Ausblick.
